# -*- coding: utf-8 -*-
"""CVAE_Embedding.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SIP2xFoULBHRvqQaKh7MsPEQbWN1qh3n
"""
...
# CVAE model
class CVAE(BaseLatentModeModuleClass):
    """
    ...
    def __init__(
        ...
        ##
        num_conditional_labels: int = 0,
        cond_dim: int = 0,
        cond_input: int = 0,
        use_embedding_for_cond: bool = True,
    ):
        super().__init__()
	...
	cond_input_dim = cond_dim if cond_input else 0
        ...
        n_input_encoder = n_input + n_continuous_cov * encode_covariates + cond_input_dim
        ...
        n_input_decoder = n_latent + n_continuous_cov + cond_dim
    ...
    def _regular_inference(
        self, x, batch_index, cont_covs=None, cat_covs=None, n_samples=1, conditional=None
    ):
        """
